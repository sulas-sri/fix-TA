<div class="modal fade" id="editCashTransactionModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
							...
							<form action="#" method="POST" id="cash-transaction-edit-form">
									...
									<div class="row">
											<div class="col-md-6">
													<div class="mb-3">
															...
															<input type="number" class="form-control" name="amount" id="amount" placeholder="Masukkan total bayar..">
													</div>
											</div>
									</div>
										...
										<div class="col-md-6">
												<div class="mb-3">
														...
														@foreach ($categories as $category)
																<div>
																		<input type="checkbox" name="category[]" value="{{ $category }}" id="category_{{ $category }}"
									...
									<div class="row">
											<div class="mb-3">
													...
													<textarea class="form-control" name="note" id="note" rows="3" placeholder="Masukkan catatan (opsional).."></textarea>
											</div>
									</div>
